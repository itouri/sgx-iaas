...
int main (int argc, char *argv[])
{
	...
	/* image_create のリクエストを待ち受ける */
	// 待ち受けるip, portをendpointへ登録
	// endpointへ通信してglanceのip, portを取得
	// image_createリクエストが来たら glance から image を読み取る
...
int do_attestation (sgx_enclave_id_t eid, config_t *config)
{
	...
	/* enclaveにVMの立ち上げを指示 いらないかも？ */
	// enclave_launch_vm(eid);
